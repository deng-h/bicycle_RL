...
from bicycle_dengh.resources.bicycle_env5 import BicycleEnv5
...
from playground.a_start.generate_grid_gemini import create_grid_map2
...
class BicycleMazeLidarEnv5(gymnasium.Env):
    ...
    def __init__(self, gui=False):
        ...
        self.bicycle = BicycleEnv5(self.client, self.max_flywheel_vel, obstacle_ids=[])
    ...
    def step(self, action):
        ...
        return obs_, reward, self.terminated, self.truncated, {}
    ...
    def reset(self, seed=None, options=None):
        ...
        goal = Goal(self.client, (self.goal[1], self.goal[0]))
    ...
    def _reward_fun(self, obs):
        ...
        # proximity_rwd = 0.0
        # if distance_to_goal_temp <= self.config["proximity_threshold"]:
